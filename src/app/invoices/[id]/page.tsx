  ...
  return (
    <div className={styles.detailPage}>
      ...
      <InvoiceDetailClient invoice={{
        ...
        companyZip: invoice.user?.companyZip || '',
        companyProvince: invoice.user?.companyProvince || '',
        companyTaxId: invoice.user?.companyTaxId || '',
        companyLogo: invoice.user?.companyLogo || '',
        logoZoom: invoice.user?.logoZoom || 1,
        logoX: invoice.user?.logoX || 0,
        logoY: invoice.user?.logoY || 0,
        paymentMethod: invoice.paymentMethod || invoice.user?.paymentMethod || '',
