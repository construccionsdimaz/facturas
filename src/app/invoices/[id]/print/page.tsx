    ...
    <div className="print-root" style={{ background: 'white' }}>
      ...
      <div className={styles.printWrapper}>
        <InvoicePDFTemplate data={{
          ...
          companyCity: settings?.companyCity || invoice.companyCity,
          companyZip: settings?.companyZip || invoice.companyZip,
          companyProvince: settings?.companyProvince || invoice.companyProvince,
