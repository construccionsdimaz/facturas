...
export const LABOR_CODE_CATALOG = [
  ...
  'LAB_BATH_MEDIUM',
  'LAB_BATH_ADAPTED',
  'LAB_BATH_SHOWER_TRAY_STD',
  'LAB_BATH_BATHTUB_STD',
  'LAB_BATH_SCREEN_STD',
  'LAB_BATH_VANITY_STD',
  'LAB_BATH_TAPWARE_STD',
  'LAB_BATH_TAPWARE_PLUS',
  'LAB_KITCH_BASIC',
  'LAB_KITCH_COMPLETE',
  'LAB_KITCH_CABINET_LOW_STD',
  'LAB_KITCH_CABINET_HIGH_STD',
  'LAB_KITCH_COUNTERTOP_STD',
  'LAB_KITCH_COUNTERTOP_PLUS',
  'LAB_KITCH_APPLIANCE_PACK_BASIC',
  'LAB_KITCH_SINK_STD',
  'LAB_KITCH_TAPWARE_STD',
  'LAB_LEVELING_LIGHT',
  'LAB_LEVELING_MEDIUM',
  'LAB_COMMON_BASIC',
  ...
  'LAB_WALL_TILE_WET_PARTIAL',
  'LAB_WALL_TILE_WET_FULL',
  'LAB_PAINT_WALL_STD',
  'LAB_PAINT_WALL_PLUS',
  'LAB_PAINT_CEILING_STD',
  'LAB_WATERPROOFING_STD',
  'LAB_WATERPROOFING_PLUS',
  ...
  'LAB_PLUMBING_WET_ROOM_PLUS',
  'LAB_DRAINAGE_WET_ROOM_PLUS',
] as const;
