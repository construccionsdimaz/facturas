...
const OFFER_SEEDS = [
  ...
  { supplier: 'Suministros Dimaz Base', material: 'PIN-PLA', unitCost: 4.05, unit: 'm2', leadTimeDays: 1, isPreferred: false },
  { supplier: 'Suministros Dimaz Base', material: 'ACA-WALL-STD', unitCost: 18.9, unit: 'm2', leadTimeDays: 4, isPreferred: false },
  { supplier: 'Suministros Dimaz Base', material: 'IMP-LIQ-STD', unitCost: 7.9, unit: 'm2', leadTimeDays: 2, isPreferred: false },
  { supplier: 'Suministros Dimaz Base', material: 'PLA-STD-13', unitCost: 6.7, unit: 'm2', leadTimeDays: 4, isPreferred: false },
  { supplier: 'Suministros Dimaz Base', material: 'PER-48', unitCost: 2.3, unit: 'ml', leadTimeDays: 4, isPreferred: false },
  { supplier: 'Suministros Dimaz Base', material: 'FON-WET-STD', unitCost: 34.2, unit: 'pt', leadTimeDays: 2, isPreferred: false },
  { supplier: 'Suministros Dimaz Base', material: 'SAN-WET-STD', unitCost: 29.2, unit: 'pt', leadTimeDays: 2, isPreferred: false },
  { supplier: 'Electro BCN', material: 'PIN-PLA', unitCost: 4.3, unit: 'm2', leadTimeDays: 1, isPreferred: false },
  { supplier: 'Electro BCN', material: 'ACA-WALL-STD', unitCost: 19.1, unit: 'm2', leadTimeDays: 3, isPreferred: false },
  ...
  { supplier: 'Suministros Dimaz Base', material: 'KIT-CAB-LOW-STD', unitCost: 121, unit: 'ml', leadTimeDays: 6, isPreferred: false },
  { supplier: 'Suministros Dimaz Base', material: 'KIT-CAB-HIGH-STD', unitCost: 99, unit: 'ml', leadTimeDays: 6, isPreferred: false },
  { supplier: 'Suministros Dimaz Base', material: 'KIT-CTOP-STD', unitCost: 44, unit: 'ml', leadTimeDays: 4, isPreferred: false },
  { supplier: 'Suministros Dimaz Base', material: 'KIT-CTOP-PLUS', unitCost: 69, unit: 'ml', leadTimeDays: 5, isPreferred: false },
  ...
  { supplier: 'Suministros Dimaz Base', material: 'CARP-DOOR-SLI', unitCost: 286, unit: 'ud', leadTimeDays: 8, isPreferred: false },
  { supplier: 'Suministros Dimaz Base', material: 'WIN-THERM-PLUS', unitCost: 541, unit: 'ud', leadTimeDays: 9, isPreferred: false },
];
